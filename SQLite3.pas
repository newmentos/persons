...
type
  TSQLiteExecCallback = function(UserData: Pointer; NumCols: integer;
    ColValues: PPAnsiCharArray; ColNames: PPAnsiCharArray): integer; cdecl;
  TSQLiteBusyHandlerCallback = function(UserData: Pointer; P2: integer): integer; cdecl;

  //function prototype for define own collate
  TCollateXCompare = function(UserData: pointer; Buf1Len: integer;
    Buf1: pointer; Buf2Len: integer; Buf2: pointer): integer; cdecl;


function SQLite3_Open(filename: PAnsiChar; var db: TSQLiteDB): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_open';

// 2009-06-20 изменение: Set пароля базы данных (после открытия базы данных
function SQLite3_Key(db: TSQLiteDB; pKey: PAnsiChar; nKey: integer): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_key';
// 2009-06-20 Изменить: изменить или удалить пароль базы данных (после открытия базы данных), вы хотите удалить пароль, то: PAnsiChar: = Nil
function SQLite3_Rekey(db: TSQLiteDB; pKey: PAnsiChar; nKey: integer): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_rekey';

function SQLite3_Close(db: TSQLiteDB): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_close';
function SQLite3_Exec(db: TSQLiteDB; SQLStatement: PAnsiChar;
  CallbackPtr: TSQLiteExecCallback; UserData: Pointer; var ErrMsg: PAnsiChar): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_exec';
function SQLite3_Version(): PAnsiChar; cdecl;
  external SQLiteDLL Name 'sqlite3_libversion';
function SQLite3_ErrMsg(db: TSQLiteDB): PAnsiChar; cdecl;
  external SQLiteDLL Name 'sqlite3_errmsg';
function SQLite3_ErrCode(db: TSQLiteDB): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_errcode';
procedure SQlite3_Free(P: PAnsiChar); cdecl; external SQLiteDLL Name 'sqlite3_free';
function SQLite3_GetTable(db: TSQLiteDB; SQLStatement: PAnsiChar;
  var ResultPtr: TSQLiteResult; var RowCount: cardinal; var ColCount: cardinal;
...
procedure SQLite3_FreeTable(Table: TSQLiteResult); cdecl;
  external SQLiteDLL Name 'sqlite3_free_table';
function SQLite3_Complete(P: PAnsiChar): boolean;
  cdecl; external SQLiteDLL Name 'sqlite3_complete';
function SQLite3_LastInsertRowID(db: TSQLiteDB): int64;
  cdecl; external SQLiteDLL Name 'sqlite3_last_insert_rowid';
procedure SQLite3_Interrupt(db: TSQLiteDB); cdecl;
  external SQLiteDLL Name 'sqlite3_interrupt';
procedure SQLite3_BusyHandler(db: TSQLiteDB; CallbackPtr: TSQLiteBusyHandlerCallback;
  UserData: Pointer); cdecl; external SQLiteDLL Name 'sqlite3_busy_handler';
procedure SQLite3_BusyTimeout(db: TSQLiteDB; TimeOut: integer); cdecl;
  external SQLiteDLL Name 'sqlite3_busy_timeout';
function SQLite3_Changes(db: TSQLiteDB): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_changes';
function SQLite3_TotalChanges(db: TSQLiteDB): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_total_changes';
function SQLite3_Prepare(db: TSQLiteDB; SQLStatement: PAnsiChar;
  nBytes: integer; var hStmt: TSqliteStmt; var pzTail: PAnsiChar): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_prepare';
function SQLite3_Prepare_v2(db: TSQLiteDB; SQLStatement: PAnsiChar;
  nBytes: integer; var hStmt: TSqliteStmt; var pzTail: PAnsiChar): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_prepare_v2';
function SQLite3_ColumnCount(hStmt: TSqliteStmt): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_column_count';
function SQLite3_ColumnName(hStmt: TSqliteStmt; ColNum: integer): PAnsiChar;
  cdecl; external SQLiteDLL Name 'sqlite3_column_name';
function SQLite3_ColumnDeclType(hStmt: TSqliteStmt; ColNum: integer): PAnsiChar;
  cdecl; external SQLiteDLL Name 'sqlite3_column_decltype';
function SQLite3_Step(hStmt: TSqliteStmt): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_step';
function SQLite3_DataCount(hStmt: TSqliteStmt): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_data_count';

function SQLite3_ColumnBlob(hStmt: TSqliteStmt; ColNum: integer): pointer;
  cdecl; external SQLiteDLL Name 'sqlite3_column_blob';
function SQLite3_ColumnBytes(hStmt: TSqliteStmt; ColNum: integer): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_column_bytes';
function SQLite3_ColumnDouble(hStmt: TSqliteStmt; ColNum: integer): double;
  cdecl; external SQLiteDLL Name 'sqlite3_column_double';
function SQLite3_ColumnInt(hStmt: TSqliteStmt; ColNum: integer): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_column_int';
function SQLite3_ColumnText(hStmt: TSqliteStmt; ColNum: integer): PAnsiChar;
  cdecl; external SQLiteDLL Name 'sqlite3_column_text';
function SQLite3_ColumnType(hStmt: TSqliteStmt; ColNum: integer): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_column_type';
function SQLite3_ColumnInt64(hStmt: TSqliteStmt; ColNum: integer): int64;
  cdecl; external SQLiteDLL Name 'sqlite3_column_int64';
function SQLite3_Finalize(hStmt: TSqliteStmt): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_finalize';
function SQLite3_Reset(hStmt: TSqliteStmt): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_reset';
...
function sqlite3_bind_double(hStmt: TSqliteStmt; ParamNum: integer;
  Data: double): integer;
...
function sqlite3_enable_shared_cache(Value: integer): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_enable_shared_cache';

//user collate definiton
function SQLite3_create_collation(db: TSQLiteDB; Name: PAnsiChar;
  eTextRep: integer; UserData: pointer; xCompare: TCollateXCompare): integer;
  cdecl; external SQLiteDLL Name 'sqlite3_create_collation';
